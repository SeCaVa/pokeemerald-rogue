const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_TUBER_F] = _("PLAYERO"),
    ...
    [TRAINER_CLASS_TOTEM_LEADER] = _("TÓTEM"),
    ...
    [TRAINER_CLASS_DEVELOPER] = _("PROGRAMADOR"),
    [TRAINER_CLASS_DEVELOPER_CHAMPION] = _("PROGRAMADOR"),
    [TRAINER_CLASS_COMMUNITY_MOD] = _("MODERADOR"),
    [TRAINER_CLASS_TEAM_ROCKET] = _("ROCKET"),
    [TRAINER_CLASS_TEAM_ROCKET_LEADER] = _("ROCKET"),
    [TRAINER_CLASS_TEAM_GALACTIC] = _("GALAXIA"),
    [TRAINER_CLASS_TEAM_GALACTIC_LEADER] = _("GALAXIA"),
    [TRAINER_CLASS_TEAM_PLASMA] = _("PLASMA"),
    [TRAINER_CLASS_TEAM_PLASMA_LEADER] = _("PLASMA"),
    [TRAINER_CLASS_TEAM_NEOPLASMA] = _("NEOPLASMA"),
    [TRAINER_CLASS_TEAM_NEOPLASMA_LEADER] = _("NEOPLASMA"),
